...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.10.0-alpha.1/iOS/Pre/Yodo1MasMediationMintegral-4.10.0-alpha.1.zip' }
...
sub.dependency 'MintegralAdSDK', '7.4.1'
sub.dependency 'MintegralAdSDK/BidSplashAd', '7.4.1'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationMintegral/Core', '4.10.0-alpha.1'
