...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.17.1-alpha.1/iOS/Pre/Yodo1MasMediationMintegral-4.17.1-alpha.1.zip' }
s.swift_version = '5.0'
...
sub.dependency 'MintegralAdSDK/All', '7.7.9'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationMintegral/Core', '4.17.1-alpha.1'
