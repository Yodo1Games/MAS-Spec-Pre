...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.11.0-alpha.6/iOS/Pre/Yodo1MasMediationMintegral-4.11.0-alpha.6.zip' }
...
sub.dependency 'MintegralAdSDK', '7.5.4'
sub.dependency 'MintegralAdSDK/BidSplashAd', '7.5.4'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationMintegral/Core', '4.11.0-alpha.6'
