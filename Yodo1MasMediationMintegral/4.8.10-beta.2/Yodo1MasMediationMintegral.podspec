...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.8.10-beta.2/iOS/Pre/Yodo1MasMediationMintegral-4.8.10-beta.2.zip' }
...
sub.dependency 'MintegralAdSDK', '= 7.3.3'
sub.dependency 'MintegralAdSDK/BidSplashAd', '= 7.3.3'
end
s.subspec 'AdMob' do |sub|
sub.dependency 'Yodo1MasMediationMintegral/Core', '4.8.10-beta.2'
