...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.8.5-dev.1/iOS/Pre/Yodo1MasMediationMintegral-4.8.5-dev.1.zip' }
...
s.dependency 'MintegralAdSDK', '= 7.2.4'
s.dependency 'MintegralAdSDK/BidSplashAd', '= 7.2.4'
end
