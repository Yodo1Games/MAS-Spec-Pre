...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.9.0-alpha.1/iOS/Pre/Yodo1MasMediationMintegral-4.9.0-alpha.1.zip' }
...
sub.dependency 'MintegralAdSDK', '7.3.9'
sub.dependency 'MintegralAdSDK/BidSplashAd', '7.3.9'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationMintegral/Core', '4.9.0-alpha.1'
