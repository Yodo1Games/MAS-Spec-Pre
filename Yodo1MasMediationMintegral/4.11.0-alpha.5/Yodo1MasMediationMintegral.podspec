...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.11.0-alpha.5/iOS/Pre/Yodo1MasMediationMintegral-4.11.0-alpha.5.zip' }
...
sub.dependency 'MintegralAdSDK', '7.5.3'
sub.dependency 'MintegralAdSDK/BidSplashAd', '7.5.3'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationMintegral/Core', '4.11.0-alpha.5'
