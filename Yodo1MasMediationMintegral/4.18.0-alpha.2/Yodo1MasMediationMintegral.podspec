...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.18.0-alpha.2/iOS/Pre/Yodo1MasMediationMintegral-4.18.0-alpha.2.zip' }
  s.swift_version    = '5.0'
...
sub.dependency 'Yodo1MasCore', '4.18.0-alpha.2'
    sub.dependency 'MintegralAdSDK/All', '8.0.4'
  end
  s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationMintegral/Core', '4.18.0-alpha.2'
...
sub.dependency 'TPNiOS', '6.5.34'
    sub.vendored_frameworks = s.name + '/Lib/AnyThinkMintegralAdapter.xcframework'
  end
end
