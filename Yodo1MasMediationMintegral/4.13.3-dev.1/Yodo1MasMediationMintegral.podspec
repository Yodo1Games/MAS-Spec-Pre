...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.13.3-dev.1/iOS/Pre/Yodo1MasMediationMintegral-4.13.3-dev.1.zip' }
...
sub.dependency 'MintegralAdSDK', '7.6.7'
sub.dependency 'MintegralAdSDK/BidSplashAd', '7.6.7'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationMintegral/Core', '4.13.3-dev.1'
