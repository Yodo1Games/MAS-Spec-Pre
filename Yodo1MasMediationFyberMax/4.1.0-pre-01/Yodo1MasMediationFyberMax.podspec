...
TODO: Add long description of the pod here.
  ...
  s.source           = { :http => 'https://docs.yodo1.com/download/Rivendell-SDKs/4.1.0-pre-01/iOS/Pre/Yodo1MasMediationFyberMax-4.1.0-pre-01.zip' }
  ...
  s.dependency 'Yodo1MasMediationFyber', '4.1.0-pre-01'
