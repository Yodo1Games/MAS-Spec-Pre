...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.8.11-rev-beta.2/iOS/Pre/Yodo1MasMediationInMobi-4.8.11-rev-beta.2.zip' }
...
sub.dependency 'Yodo1MasMediationInMobi/Core', '4.8.11-rev-beta.2'
