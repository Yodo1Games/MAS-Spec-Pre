...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.9.2-alpha.1/iOS/Pre/Yodo1MasMediationInMobi-4.9.2-alpha.1.zip' }
...
sub.dependency 'Yodo1MasMediationInMobi/Core', '4.9.2-alpha.1'
