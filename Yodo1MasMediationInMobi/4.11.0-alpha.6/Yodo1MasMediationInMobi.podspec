...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.11.0-alpha.6/iOS/Pre/Yodo1MasMediationInMobi-4.11.0-alpha.6.zip' }
...
sub.dependency 'InMobiSDK', '10.6.0'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationInMobi/Core', '4.11.0-alpha.6'
