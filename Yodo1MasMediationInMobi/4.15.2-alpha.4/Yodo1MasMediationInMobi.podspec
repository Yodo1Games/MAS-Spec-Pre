...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.15.2-alpha.4/iOS/Pre/Yodo1MasMediationInMobi-4.15.2-alpha.4.zip' }
s.swift_version = '5.0'
...
sub.dependency 'InMobiSDK', '10.8.3'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationInMobi/Core', '4.15.2-alpha.4'
