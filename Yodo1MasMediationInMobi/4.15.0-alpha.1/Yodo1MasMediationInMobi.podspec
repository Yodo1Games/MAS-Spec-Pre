...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.15.0-alpha.1/iOS/Pre/Yodo1MasMediationInMobi-4.15.0-alpha.1.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Yodo1MasMediationInMobi/Core', '4.15.0-alpha.1'
