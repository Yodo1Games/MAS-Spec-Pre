...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.8.10-beta.2/iOS/Pre/Yodo1MasMediationInMobi-4.8.10-beta.2.zip' }
...
sub.dependency 'InMobiSDK/Core', '10.1.3'
end
s.subspec 'AdMob' do |sub|
sub.dependency 'Yodo1MasMediationInMobi/Core', '4.8.10-beta.2'
