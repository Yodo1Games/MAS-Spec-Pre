...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.0-alpha.4/iOS/Pre/Yodo1MasMediationInMobi-4.14.0-alpha.4.zip' }
...
sub.dependency 'InMobiSDK', '10.7.5'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationInMobi/Core', '4.14.0-alpha.4'
