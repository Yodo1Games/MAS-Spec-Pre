...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.18.0-alpha.2/iOS/Pre/Yodo1MasMediationInMobi-4.18.0-alpha.2.zip' }
  s.swift_version    = '5.0'
...
sub.dependency 'Yodo1MasCore', '4.18.0-alpha.2'
    sub.dependency 'InMobiSDK', '10.8.8'
  end
  s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationInMobi/Core', '4.18.0-alpha.2'
