...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.10.0-alpha.1/iOS/Pre/Yodo1MasMediationInMobi-4.10.0-alpha.1.zip' }
...
sub.dependency 'InMobiSDK/Core', '10.1.4'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationInMobi/Core', '4.10.0-alpha.1'
