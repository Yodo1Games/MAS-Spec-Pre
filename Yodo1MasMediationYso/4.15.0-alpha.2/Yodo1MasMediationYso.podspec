...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.15.0-alpha.2/iOS/Pre/Yodo1MasMediationYso-4.15.0-alpha.2.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Yodo1MasMediationYso/Core', '4.15.0-alpha.2'
