...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.18.0-beta.1/iOS/Pre/Yodo1MasMediationTopOn-4.18.0-beta.1.zip' }
  s.swift_version    = '5.0'
...
sub.dependency 'Yodo1MasMediationTopOn/Core', '4.18.0-beta.1'
