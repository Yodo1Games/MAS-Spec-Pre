...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.16.1-dev.1/iOS/Pre/Yodo1MasMediationTopOn-4.16.1-dev.1.zip' }
s.swift_version = '5.0'
...
sub.dependency 'HyperbidToolsMCSDK', '3.5.10'
end
s.subspec 'TopOn' do |sub|
sub.dependency 'Yodo1MasMediationTopOn/Core', '4.16.1-dev.1'
