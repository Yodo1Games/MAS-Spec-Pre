Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://mas-artifacts.yodo1.com/5.0.0-alpha.6/iOS/Pre/Yodo1MasMediationTopOn-5.0.0-alpha.6.zip' }
  s.swift_version    = '5.0'
  ...
  s.subspec 'Core' do |sub|
    ...
    sub.dependency 'HyperbidToolsMCSDK', '4.1.12'
    sub.dependency 'MCSDKMaterialPlugin', '1.1.0'
  end
  s.subspec 'TopOn' do |sub|
    sub.dependency 'Yodo1MasMediationTopOn/Core', '5.0.0-alpha.6'
    ...
    sub.dependency 'TPNMediationAdxSmartdigimktAdapter', '6.5.75.2.0'
  end
end
