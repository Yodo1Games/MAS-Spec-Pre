...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.15.2-alpha.3/iOS/Pre/Yodo1MasMediationTencent-4.15.2-alpha.3.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Yodo1MasMediationTencent/Core', '4.15.2-alpha.3'
