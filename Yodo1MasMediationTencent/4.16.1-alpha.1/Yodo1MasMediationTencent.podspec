...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.16.1-alpha.1/iOS/Pre/Yodo1MasMediationTencent-4.16.1-alpha.1.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Yodo1MasMediationTencent/Core', '4.16.1-alpha.1'
