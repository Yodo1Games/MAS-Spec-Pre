...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.18.0-alpha.4/iOS/Pre/Yodo1MasMediationTencent-4.18.0-alpha.4.zip' }
  s.swift_version    = '5.0'
...
sub.dependency 'Yodo1MasCore', '4.18.0-alpha.4'
    sub.dependency 'GDTMobSDK', '4.15.75'
  end
...
sub.dependency 'Yodo1MasMediationTencent/Core', '4.18.0-alpha.4'
