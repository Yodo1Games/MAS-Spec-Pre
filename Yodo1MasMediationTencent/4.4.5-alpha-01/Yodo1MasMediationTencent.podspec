...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.4.5-alpha-01/iOS/Pre/Yodo1MasMediationTencent-4.4.5-alpha-01.zip' }
...
s.public_header_files = s.name + '/Classes/**/*.h',s.name + '/Lib/*.h'
