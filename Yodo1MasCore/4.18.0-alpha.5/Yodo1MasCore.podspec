...
s.license = { :type => 'MIT', :file => 'LICENSE' }
  ...
  DESC
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.18.0-alpha.5/iOS/Pre/Yodo1MasCore-4.18.0-alpha.5.zip' }
  s.swift_version    = '5.0'
  ...
  # No armv7: CocoaPods lint otherwise adds ARCHS=x86_64 (armv7 without i386), breaking AS simulator lint.
