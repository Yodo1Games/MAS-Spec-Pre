...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.9.3-beta.1/iOS/Pre/Yodo1MasMediationPangle-4.9.3-beta.1.zip' }
...
sub.dependency 'Yodo1MasMediationPangle/Core', '4.9.3-beta.1'
sub.dependency 'AppLovinSDK', '11.10.1'
sub.vendored_frameworks = s.name + '/Lib/AppLovinMediationByteDanceAdapter.xcframework', s.name + '/Lib/AppLovinMediationCSJAdapter.xcframework'
end
