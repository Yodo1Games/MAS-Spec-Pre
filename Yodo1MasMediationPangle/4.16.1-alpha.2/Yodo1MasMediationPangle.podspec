...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.16.1-alpha.2/iOS/Pre/Yodo1MasMediationPangle-4.16.1-alpha.2.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Ads-Global', '7.4.0.7'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationPangle/Core', '4.16.1-alpha.2'
