Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://mas-artifacts.yodo1.com/5.0.0-alpha.6/iOS/Pre/Yodo1MasMediationPangle-5.0.0-alpha.6.zip' }
  s.swift_version    = '5.0'
  ...
  s.subspec 'Core' do |sub|
    ...
    sub.dependency 'Ads-Global', '8.2.1.0'
  end
  s.subspec 'AppLovin' do |sub|
    sub.dependency 'Yodo1MasMediationPangle/Core', '5.0.0-alpha.6'
