...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.15.0-alpha.3/iOS/Pre/Yodo1MasMediationPangle-4.15.0-alpha.3.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Ads-Global', '6.5.0.8'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationPangle/Core', '4.15.0-alpha.3'
