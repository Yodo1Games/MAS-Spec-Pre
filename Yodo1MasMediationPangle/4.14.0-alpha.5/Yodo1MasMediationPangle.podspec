...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.0-alpha.5/iOS/Pre/Yodo1MasMediationPangle-4.14.0-alpha.5.zip' }
...
sub.dependency 'Ads-Global/BUAdSDK_Compatible', '6.2.0.6'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationPangle/Core', '4.14.0-alpha.5'
