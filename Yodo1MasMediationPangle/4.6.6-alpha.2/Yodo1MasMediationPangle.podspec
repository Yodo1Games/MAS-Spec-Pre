...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.6.6-alpha.2/iOS/Pre/Yodo1MasMediationPangle-4.6.6-alpha.2.zip' }
...
s.dependency 'Ads-Global/BUAdSDK', '4.3.0.2'
s.dependency 'Ads-Global/Domestic', '4.3.0.2'
