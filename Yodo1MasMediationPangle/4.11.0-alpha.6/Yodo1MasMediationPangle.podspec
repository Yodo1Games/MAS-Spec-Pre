...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.11.0-alpha.6/iOS/Pre/Yodo1MasMediationPangle-4.11.0-alpha.6.zip' }
...
sub.dependency 'Ads-Global/BUAdSDK_Compatible', '5.7.0.7'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationPangle/Core', '4.11.0-alpha.6'
