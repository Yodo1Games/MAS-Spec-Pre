...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.8.5-dev.1/iOS/Pre/Yodo1MasMediationPangle-4.8.5-dev.1.zip' }
...
s.dependency 'Ads-Global/BUAdSDK_Compatible', '= 4.7.0.8'
s.dependency 'Ads-CN/BUAdSDK_Compatible', '= 4.7.1.1'
