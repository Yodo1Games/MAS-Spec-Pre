...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.18.0-beta.2/iOS/Pre/Yodo1MasMediationPangle-4.18.0-beta.2.zip' }
  s.swift_version    = '5.0'
...
sub.dependency 'Yodo1MasMediationPangle/Core', '4.18.0-beta.2'
