...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.15.2-alpha.2/iOS/Pre/Yodo1MasMediationPangle-4.15.2-alpha.2.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Yodo1MasMediationPangle/Core', '4.15.2-alpha.2'
