...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.9.0-alpha.1/iOS/Pre/Yodo1MasMediationPangle-4.9.0-alpha.1.zip' }
...
sub.dependency 'Ads-Global/BUAdSDK_Compatible', '5.3.1.0'
sub.dependency 'Ads-CN/BUAdSDK_Compatible', '4.9.0.7'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationPangle/Core', '4.9.0-alpha.1'
