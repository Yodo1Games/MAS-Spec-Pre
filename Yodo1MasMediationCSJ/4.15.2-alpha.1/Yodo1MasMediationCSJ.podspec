...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.15.2-alpha.1/iOS/Pre/Yodo1MasMediationCSJ-4.15.2-alpha.1.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Ads-CN/BUAdSDK', '6.8.1.3'
sub.dependency 'Ads-CN/CSJMediation', '6.8.1.3'
end
...
sub.dependency 'Yodo1MasMediationCSJ/Core', '4.15.2-alpha.1'
sub.dependency 'ToBid-iOS', '4.5.4'
