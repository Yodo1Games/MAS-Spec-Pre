...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.0-alpha.5/iOS/Pre/Yodo1MasMediationCSJ-4.14.0-alpha.5.zip' }
...
sub.dependency 'Ads-CN/CSJMediation', '6.3.0.6'
end
...
sub.dependency 'Yodo1MasMediationCSJ/Core', '4.14.0-alpha.5'
