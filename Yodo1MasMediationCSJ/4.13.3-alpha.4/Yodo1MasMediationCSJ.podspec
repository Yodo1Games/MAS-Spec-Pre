...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.13.3-alpha.4/iOS/Pre/Yodo1MasMediationCSJ-4.13.3-alpha.4.zip' }
...
sub.dependency 'Ads-CN/BUAdSDK', '6.3.0.6'
end
...
sub.dependency 'Yodo1MasMediationCSJ/Core', '4.13.3-alpha.4'
