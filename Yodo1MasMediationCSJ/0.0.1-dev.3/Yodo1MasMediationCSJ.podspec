...
s.source = { :http => 'https://mas-artifacts.yodo1.com/0.0.1-dev.3/iOS/Pre/Yodo1MasMediationCSJ-0.0.1-dev.3.zip' }
...
sub.dependency 'Ads-CN/BUAdSDK', '6.0.1.2'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationCSJ/Core', '0.0.1-dev.3'
