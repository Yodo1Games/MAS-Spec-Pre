...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.13.3-dev.1/iOS/Pre/Yodo1MasMediationCSJ-4.13.3-dev.1.zip' }
...
sub.vendored_frameworks = s.name + '/Lib/CSJMediation.xcframework'
end
end
