...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.17.1-alpha.1/iOS/Pre/Yodo1MasMediationCSJ-4.17.1-alpha.1.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Ads-CN/BUAdSDK', '6.8.1.7'
sub.dependency 'Ads-CN/CSJMediation', '6.8.1.7'
end
# s.subspec 'AppLovin' do |sub|
# sub.dependency, '4.17.1-alpha.1'
# sub.dependency, '13.3.1'
# sub.vendored_frameworks = s.name + '/Lib/AppLovinMediationCSJAdapter.xcframework'
# end
s.subspec 'ToBid' do |sub|
sub.dependency 'Yodo1MasMediationCSJ/Core', '4.17.1-alpha.1'
sub.dependency 'ToBid-iOS/ToBidSDK', '4.5.20'
