...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.18.0-alpha.4/iOS/Pre/Yodo1MasMediationCSJ-4.18.0-alpha.4.zip' }
  s.swift_version    = '5.0'
...
sub.dependency 'Yodo1MasCore', '4.18.0-alpha.4'
    sub.dependency 'Ads-CN/BUAdSDK', '7.2.1.5'
    sub.dependency 'Ads-CN/CSJMediation-Only', '7.2.1.5'
  end
  #  s.subspec 'AppLovin' do |sub|
# sub.dependency, '4.18.0-alpha.4'
# sub.dependency, '13.5.1'
  #    sub.vendored_frameworks = s.name + '/Lib/AppLovinMediationCSJAdapter.xcframework'
  #  end
  s.subspec 'ToBid' do |sub|
sub.dependency 'Yodo1MasMediationCSJ/Core', '4.18.0-alpha.4'
