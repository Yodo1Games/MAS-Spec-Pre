...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.18.0-alpha.2/iOS/Pre/Yodo1MasMediationCSJ-4.18.0-alpha.2.zip' }
  s.swift_version    = '5.0'
...
# sub.dependency, '4.18.0-alpha.2'
# sub.dependency, '13.5.0'
  #    sub.vendored_frameworks = s.name + '/Lib/AppLovinMediationCSJAdapter.xcframework'
  #  end
  s.subspec 'ToBid' do |sub|
sub.dependency 'Yodo1MasMediationCSJ/Core', '4.18.0-alpha.2'
