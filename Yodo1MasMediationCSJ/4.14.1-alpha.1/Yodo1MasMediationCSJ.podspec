...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.1-alpha.1/iOS/Pre/Yodo1MasMediationCSJ-4.14.1-alpha.1.zip' }
...
sub.dependency 'Ads-CN/BUAdSDK', '6.4.1.0'
sub.dependency 'Ads-CN/CSJMediation', '6.4.1.0'
end
...
sub.dependency 'Yodo1MasMediationCSJ/Core', '4.14.1-alpha.1'
