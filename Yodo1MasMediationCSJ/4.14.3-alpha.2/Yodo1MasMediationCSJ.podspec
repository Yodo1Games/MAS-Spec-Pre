...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.3-alpha.2/iOS/Pre/Yodo1MasMediationCSJ-4.14.3-alpha.2.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Ads-CN/BUAdSDK', '6.5.0.9'
sub.dependency 'Ads-CN/CSJMediation', '6.5.0.9'
end
...
sub.dependency 'Yodo1MasMediationCSJ/Core', '4.14.3-alpha.2'
sub.dependency 'ToBid-iOS', '4.3.10'
