...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.3-alpha.1/iOS/Pre/Yodo1MasMediationBidMachine-4.14.3-alpha.1.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Yodo1MasMediationBidMachine/Core', '4.14.3-alpha.1'
