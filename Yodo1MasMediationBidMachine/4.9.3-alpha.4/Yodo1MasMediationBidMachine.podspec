...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.9.3-alpha.4/iOS/Pre/Yodo1MasMediationBidMachine-4.9.3-alpha.4.zip' }
...
sub.dependency 'Yodo1MasMediationBidMachine/Core', '4.9.3-alpha.4'
