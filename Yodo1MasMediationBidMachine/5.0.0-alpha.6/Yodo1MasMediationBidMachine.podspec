Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://mas-artifacts.yodo1.com/5.0.0-alpha.6/iOS/Pre/Yodo1MasMediationBidMachine-5.0.0-alpha.6.zip' }
  s.swift_version    = '5.0'
  ...
  s.subspec 'Core' do |sub|
    ...
    sub.dependency 'BidMachine', '3.7.1'
  end
  s.subspec 'AppLovin' do |sub|
    sub.dependency 'Yodo1MasMediationBidMachine/Core', '5.0.0-alpha.6'
  ...
  s.subspec 'AdMob' do |sub|
    ...
    sub.vendored_frameworks = s.name + '/Lib/GoogleBidMachineAdapter.xcframework'
  end
  s.subspec 'IronSource' do |sub|
    sub.dependency 'Yodo1MasMediationBidMachine/Core', '5.0.0-alpha.6'
    sub.dependency 'IronSourceSDK', '9.3.0.0'
    sub.vendored_frameworks = s.name + '/Lib/ISBidMachineAdapter.xcframework'
  end
  s.subspec 'TopOn' do |sub|
    sub.dependency 'Yodo1MasMediationBidMachine/Core', '5.0.0-alpha.6'
    sub.dependency 'TPNiOS', '6.5.73'
    sub.vendored_frameworks = s.name + '/Lib/AnyThinkBidMachineAdapter.xcframework'
  end
end
