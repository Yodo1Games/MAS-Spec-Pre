...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.0-alpha.5/iOS/Pre/Yodo1MasMediationBidMachine-4.14.0-alpha.5.zip' }
...
sub.dependency 'BidMachine', '3.0.0'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationBidMachine/Core', '4.14.0-alpha.5'
