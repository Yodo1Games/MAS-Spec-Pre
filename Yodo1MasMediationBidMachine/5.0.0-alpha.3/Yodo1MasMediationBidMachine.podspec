Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://mas-artifacts.yodo1.com/5.0.0-alpha.3/iOS/Pre/Yodo1MasMediationBidMachine-5.0.0-alpha.3.zip' }
  s.swift_version    = '5.0'
  ...
  s.subspec 'Core' do |sub|
    ...
    sub.dependency 'BidMachine', '3.5.1'
  end
  s.subspec 'AppLovin' do |sub|
    sub.dependency 'Yodo1MasMediationBidMachine/Core', '5.0.0-alpha.3'
