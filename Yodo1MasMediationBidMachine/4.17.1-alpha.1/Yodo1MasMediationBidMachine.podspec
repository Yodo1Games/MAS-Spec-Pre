...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.17.1-alpha.1/iOS/Pre/Yodo1MasMediationBidMachine-4.17.1-alpha.1.zip' }
s.swift_version = '5.0'
...
sub.dependency 'BidMachine', '3.4.0'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationBidMachine/Core', '4.17.1-alpha.1'
