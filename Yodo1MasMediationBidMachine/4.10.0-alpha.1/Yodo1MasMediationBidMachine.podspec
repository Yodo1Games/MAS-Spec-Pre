...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.10.0-alpha.1/iOS/Pre/Yodo1MasMediationBidMachine-4.10.0-alpha.1.zip' }
...
sub.dependency 'BidMachine', '2.3.0.2'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationBidMachine/Core', '4.10.0-alpha.1'
