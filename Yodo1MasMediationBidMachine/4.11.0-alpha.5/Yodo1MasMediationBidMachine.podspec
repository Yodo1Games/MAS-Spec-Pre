...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.11.0-alpha.5/iOS/Pre/Yodo1MasMediationBidMachine-4.11.0-alpha.5.zip' }
...
sub.dependency 'BidMachine', '2.4.0.1'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationBidMachine/Core', '4.11.0-alpha.5'
