...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.15.0-alpha.4/iOS/Pre/Yodo1MasMediationBidMachine-4.15.0-alpha.4.zip' }
s.swift_version = '5.0'
...
sub.dependency 'BidMachine', '3.2.0'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationBidMachine/Core', '4.15.0-alpha.4'
