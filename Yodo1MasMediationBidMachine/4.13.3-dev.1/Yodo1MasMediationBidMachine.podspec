...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.13.3-dev.1/iOS/Pre/Yodo1MasMediationBidMachine-4.13.3-dev.1.zip' }
...
sub.dependency 'BidMachine', '2.7.0.0'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationBidMachine/Core', '4.13.3-dev.1'
