...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.12.0-beta.1/iOS/Pre/Yodo1MasMediationVungle-4.12.0-beta.1.zip' }
...
sub.dependency 'Yodo1MasCore', '4.12.0-beta.1'
sub.dependency 'VungleAds', '7.2.1'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationVungle/Core', '4.12.0-beta.1'
