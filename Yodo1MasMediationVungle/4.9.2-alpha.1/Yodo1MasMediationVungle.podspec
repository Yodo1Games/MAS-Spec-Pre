...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.9.2-alpha.1/iOS/Pre/Yodo1MasMediationVungle-4.9.2-alpha.1.zip' }
...
sub.dependency 'Yodo1MasMediationVungle/Core', '4.9.2-alpha.1'
