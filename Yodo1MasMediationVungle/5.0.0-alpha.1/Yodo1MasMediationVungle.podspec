...
s.source = { :http => 'https://mas-artifacts.yodo1.com/5.0.0-alpha.1/iOS/Pre/Yodo1MasMediationVungle-5.0.0-alpha.1.zip' }
  s.swift_version    = '5.0'
...
sub.dependency 'Yodo1MasMediationVungle/Core', '5.0.0-alpha.1'
