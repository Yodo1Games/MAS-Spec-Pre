...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.0-alpha.4/iOS/Pre/Yodo1MasMediationVungle-4.14.0-alpha.4.zip' }
...
sub.dependency 'Yodo1MasCore', '4.14.0-alpha.4'
sub.dependency 'VungleAds', '7.4.1'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationVungle/Core', '4.14.0-alpha.4'
