...
s.source = { :http => 'https://mas-artifacts.yodo1.com/0.0.1-dev.2/iOS/Pre/Yodo1MasMediationVungle-0.0.1-dev.2.zip' }
...
sub.dependency 'Yodo1MasCore', '0.0.1-dev.2'
sub.dependency 'VungleAds', '7.3.2'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationVungle/Core', '0.0.1-dev.2'
