...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.10.0-alpha.1/iOS/Pre/Yodo1MasMediationVungle-4.10.0-alpha.1.zip' }
...
sub.dependency 'VungleSDK-iOS', '6.12.3'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationVungle/Core', '4.10.0-alpha.1'
