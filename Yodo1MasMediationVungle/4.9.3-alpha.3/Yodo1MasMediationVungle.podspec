...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.9.3-alpha.3/iOS/Pre/Yodo1MasMediationVungle-4.9.3-alpha.3.zip' }
...
sub.dependency 'Yodo1MasMediationVungle/Core', '4.9.3-alpha.3'
