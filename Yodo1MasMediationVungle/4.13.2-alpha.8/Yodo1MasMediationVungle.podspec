...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.13.2-alpha.8/iOS/Pre/Yodo1MasMediationVungle-4.13.2-alpha.8.zip' }
...
sub.dependency 'Yodo1MasCore', '4.13.2-alpha.8'
sub.dependency 'VungleAds', '7.3.2'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationVungle/Core', '4.13.2-alpha.8'
