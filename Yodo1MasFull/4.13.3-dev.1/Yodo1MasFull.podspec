...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.13.3-dev.1/iOS/Pre/Yodo1MasFull-4.13.3-dev.1.zip' }
...
s.dependency 'Yodo1MasCore', '4.13.3-dev.1'
s.dependency 'Yodo1MasMediationAdMob', '4.13.3-dev.1'
s.dependency 'Yodo1MasMediationApplovin', '4.13.3-dev.1'
s.dependency 'Yodo1MasMediationFyber', '4.13.3-dev.1'
s.dependency 'Yodo1MasMediationBidMachine', '4.13.3-dev.1'
s.dependency 'Yodo1MasMediationBigo', '4.13.3-dev.1'
s.dependency 'Yodo1MasMediationIronSource', '4.13.3-dev.1'
s.dependency 'Yodo1MasMediationFacebook', '4.13.3-dev.1'
s.dependency 'Yodo1MasMediationInMobi', '4.13.3-dev.1'
s.dependency 'Yodo1MasMediationMintegral', '4.13.3-dev.1'
s.dependency 'Yodo1MasMediationPangle', '4.13.3-dev.1'
s.dependency 'Yodo1MasMediationCSJ', '4.13.3-dev.1'
s.dependency 'Yodo1MasMediationTencent', '4.13.3-dev.1'
s.dependency 'Yodo1MasMediationToBid', '4.13.3-dev.1'
s.dependency 'Yodo1MasMediationUnityAds', '4.13.3-dev.1'
s.dependency 'Yodo1MasMediationVungle', '4.13.3-dev.1'
s.dependency 'Yodo1MasMediationYandex', '4.13.3-dev.1'
s.dependency 'Yodo1MasMediationYodo1', '4.13.3-dev.1'
end
