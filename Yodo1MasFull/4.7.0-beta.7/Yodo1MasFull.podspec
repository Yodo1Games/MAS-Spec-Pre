...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.7.0-beta.7/iOS/Pre/Yodo1MasFull-4.7.0-beta.7.zip' }
...
s.dependency 'Yodo1MasCore', '4.7.0-beta.7'
s.dependency 'Yodo1MasMediationAdMob', '4.7.0-beta.7'
s.dependency 'Yodo1MasMediationApplovin', '4.7.0-beta.7'
s.dependency 'Yodo1MasMediationFyber', '4.7.0-beta.7'
s.dependency 'Yodo1MasMediationIronSource', '4.7.0-beta.7'
# s.dependency, '4.7.0-beta.7'
s.dependency 'Yodo1MasMediationFacebook', '4.7.0-beta.7'
s.dependency 'Yodo1MasMediationInMobi', '4.7.0-beta.7'
#s.dependency 'Yodo1MasMediationMintegral', '4.7.0-beta.7'
s.dependency 'Yodo1MasMediationMyTarget', '4.7.0-beta.7'
s.dependency 'Yodo1MasMediationPangle', '4.7.0-beta.7'
s.dependency 'Yodo1MasMediationTapjoy', '4.7.0-beta.7'
s.dependency 'Yodo1MasMediationTencent', '4.7.0-beta.7'
s.dependency 'Yodo1MasMediationUnityAds', '4.7.0-beta.7'
s.dependency 'Yodo1MasMediationVungle', '4.7.0-beta.7'
s.dependency 'Yodo1MasMediationYandex', '4.7.0-beta.7'
s.dependency 'Yodo1MasMediationYodo1', '4.7.0-beta.7'
end
