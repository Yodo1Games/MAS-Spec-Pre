...
s.source = { :http => 'https://mas-artifacts.yodo1.com/0.0.1-dev.4/iOS/Pre/Yodo1MasFull-0.0.1-dev.4.zip' }
...
s.dependency 'Yodo1MasCore', '0.0.1-dev.4'
s.dependency 'Yodo1MasMediationAdMob', '0.0.1-dev.4'
s.dependency 'Yodo1MasMediationApplovin', '0.0.1-dev.4'
s.dependency 'Yodo1MasMediationFyber', '0.0.1-dev.4'
s.dependency 'Yodo1MasMediationBidMachine', '0.0.1-dev.4'
s.dependency 'Yodo1MasMediationBigo', '0.0.1-dev.4'
s.dependency 'Yodo1MasMediationIronSource', '0.0.1-dev.4'
s.dependency 'Yodo1MasMediationFacebook', '0.0.1-dev.4'
s.dependency 'Yodo1MasMediationInMobi', '0.0.1-dev.4'
s.dependency 'Yodo1MasMediationMintegral', '0.0.1-dev.4'
s.dependency 'Yodo1MasMediationPangle', '0.0.1-dev.4'
s.dependency 'Yodo1MasMediationCSJ', '0.0.1-dev.4'
s.dependency 'Yodo1MasMediationTencent', '0.0.1-dev.4'
s.dependency 'Yodo1MasMediationUnityAds', '0.0.1-dev.4'
s.dependency 'Yodo1MasMediationVungle', '0.0.1-dev.4'
s.dependency 'Yodo1MasMediationYandex', '0.0.1-dev.4'
# s.dependency, '0.0.1-dev.4'
s.dependency 'Yodo1MasMediationYodo1', '0.0.1-dev.4'
end
