...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.6.0-beta-07/iOS/Pre/Yodo1MasFull-4.6.0-beta-07.zip' }
...
s.dependency 'Yodo1MasCore', '4.6.0-beta-07'
s.dependency 'Yodo1MasMediationAdMobMax', '4.6.0-beta-07'
s.dependency 'Yodo1MasMediationApplovinMax', '4.6.0-beta-07'
s.dependency 'Yodo1MasMediationFyberMax', '4.6.0-beta-07'
s.dependency 'Yodo1MasMediationIronSourceMax', '4.6.0-beta-07'

# s.dependency, '4.6.0-beta-07'
s.dependency 'Yodo1MasMediationFacebookMax', '4.6.0-beta-07'
s.dependency 'Yodo1MasMediationInMobiMax', '4.6.0-beta-07'
#s.dependency 'Yodo1MasMediationMintegralMax', '4.6.0-beta-07'
s.dependency 'Yodo1MasMediationMyTargetMax', '4.6.0-beta-07'
s.dependency 'Yodo1MasMediationPangleMax', '4.6.0-beta-07'
s.dependency 'Yodo1MasMediationTapjoyMax', '4.6.0-beta-07'
s.dependency 'Yodo1MasMediationTencentMax', '4.6.0-beta-07'
s.dependency 'Yodo1MasMediationUnityAdsMax', '4.6.0-beta-07'
s.dependency 'Yodo1MasMediationVungleMax', '4.6.0-beta-07'
s.dependency 'Yodo1MasMediationYandexMax', '4.6.0-beta-07'
s.dependency 'Yodo1MasMediationYodo1', '4.6.0-beta-07'
end
