...
s.dependency 'Yodo1MasCore', '4.3.0-beta-08'
s.dependency 'Yodo1MasMediationAdMobMax', '4.3.0-beta-08'
s.dependency 'Yodo1MasMediationApplovinMax', '4.3.0-beta-08'
s.dependency 'Yodo1MasMediationFyberMax', '4.3.0-beta-08'
s.dependency 'Yodo1MasMediationIronSourceMax', '4.3.0-beta-08'

s.dependency 'Yodo1MasMediationAdColonyMax', '4.3.0-beta-08'
s.dependency 'Yodo1MasMediationFacebookMax', '4.3.0-beta-08'
s.dependency 'Yodo1MasMediationInMobiMax', '4.3.0-beta-08'
#s.dependency 'Yodo1MasMediationMintegralMax', '4.3.0-beta-08'
s.dependency 'Yodo1MasMediationMyTargetMax', '4.3.0-beta-08'
s.dependency 'Yodo1MasMediationPangleMax', '4.3.0-beta-08'
s.dependency 'Yodo1MasMediationTapjoyMax', '4.3.0-beta-08'
s.dependency 'Yodo1MasMediationTencentMax', '4.3.0-beta-08'
s.dependency 'Yodo1MasMediationUnityAdsMax', '4.3.0-beta-08'
s.dependency 'Yodo1MasMediationVungleMax', '4.3.0-beta-08'
s.dependency 'Yodo1MasMediationYandexMax', '4.3.0-beta-08'
end
