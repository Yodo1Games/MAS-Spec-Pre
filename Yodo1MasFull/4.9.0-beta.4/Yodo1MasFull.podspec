...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.9.0-beta.4/iOS/Pre/Yodo1MasFull-4.9.0-beta.4.zip' }
...
s.dependency 'Yodo1MasCore', '4.9.0-beta.4'
s.dependency 'Yodo1MasMediationAdMob', '4.9.0-beta.4'
s.dependency 'Yodo1MasMediationApplovin', '4.9.0-beta.4'
s.dependency 'Yodo1MasMediationFyber', '4.9.0-beta.4'
s.dependency 'Yodo1MasMediationIronSource', '4.9.0-beta.4'
s.dependency 'Yodo1MasMediationFacebook', '4.9.0-beta.4'
s.dependency 'Yodo1MasMediationInMobi', '4.9.0-beta.4'
s.dependency 'Yodo1MasMediationMintegral', '4.9.0-beta.4'
s.dependency 'Yodo1MasMediationMyTarget', '4.9.0-beta.4'
s.dependency 'Yodo1MasMediationPangle', '4.9.0-beta.4'
s.dependency 'Yodo1MasMediationTencent', '4.9.0-beta.4'
s.dependency 'Yodo1MasMediationUnityAds', '4.9.0-beta.4'
s.dependency 'Yodo1MasMediationVungle', '4.9.0-beta.4'
s.dependency 'Yodo1MasMediationYandex', '4.9.0-beta.4'
s.dependency 'Yodo1MasMediationKidoz', '4.9.0-beta.4'
s.dependency 'Yodo1MasMediationYodo1', '4.9.0-beta.4'
end
