...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.15.0-beta.1/iOS/Pre/Yodo1MasMediationMoloco-4.15.0-beta.1.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Yodo1MasMediationMoloco/Core', '4.15.0-beta.1'
