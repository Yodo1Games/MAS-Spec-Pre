...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.0-alpha.5/iOS/Pre/Yodo1MasMediationMoloco-4.14.0-alpha.5.zip' }
...
sub.dependency 'MolocoSDKiOS', '3.1.3'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationMoloco/Core', '4.14.0-alpha.5'
