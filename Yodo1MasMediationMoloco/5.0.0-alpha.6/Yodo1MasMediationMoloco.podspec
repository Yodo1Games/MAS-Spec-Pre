Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://mas-artifacts.yodo1.com/5.0.0-alpha.6/iOS/Pre/Yodo1MasMediationMoloco-5.0.0-alpha.6.zip' }
  s.swift_version    = '5.0'
  ...
  s.subspec 'Core' do |sub|
    ...
    sub.dependency 'MolocoSDKiOS', '4.9.0'
  end
  s.subspec 'AppLovin' do |sub|
    sub.dependency 'Yodo1MasMediationMoloco/Core', '5.0.0-alpha.6'
