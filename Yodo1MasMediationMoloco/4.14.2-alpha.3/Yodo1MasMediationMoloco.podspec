...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.2-alpha.3/iOS/Pre/Yodo1MasMediationMoloco-4.14.2-alpha.3.zip' }
s.swift_version = '5.0'
...
sub.dependency 'MolocoSDKiOS', '3.4.0'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationMoloco/Core', '4.14.2-alpha.3'
