...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.17.1-beta.2/iOS/Pre/Yodo1MasMediationMoloco-4.17.1-beta.2.zip' }
  s.swift_version    = '5.0'
...
sub.dependency 'Yodo1MasMediationMoloco/Core', '4.17.1-beta.2'
