...
s.source = { :http => 'https://mas-artifacts.yodo1.com/0.0.1-dev.2/iOS/Pre/Yodo1MasMediationIronSource-0.0.1-dev.2.zip' }
...
sub.dependency 'Yodo1MasMediationIronSource/Core', '0.0.1-dev.2'
