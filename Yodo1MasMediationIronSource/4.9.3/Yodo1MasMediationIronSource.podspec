...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.9.3/iOS/Pre/Yodo1MasMediationIronSource-4.9.3.zip' }
...
sub.dependency 'Yodo1MasCore', '4.9.3'
sub.dependency 'IronSourceSDK', '7.3.1.0'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationIronSource/Core', '4.9.3'
