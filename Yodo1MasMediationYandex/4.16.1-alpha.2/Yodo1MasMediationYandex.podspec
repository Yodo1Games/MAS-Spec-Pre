...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.16.1-alpha.2/iOS/Pre/Yodo1MasMediationYandex-4.16.1-alpha.2.zip' }
...
sub.dependency 'Yodo1MasMediationYandex/Core', '4.16.1-alpha.2'
