...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.15.1-dev.3/iOS/Pre/Yodo1MasMediationYandex-4.15.1-dev.3.zip' }
s.swift_version = '5.7'
...
sub.dependency 'Yodo1MasMediationYandex/Core', '4.15.1-dev.3'
