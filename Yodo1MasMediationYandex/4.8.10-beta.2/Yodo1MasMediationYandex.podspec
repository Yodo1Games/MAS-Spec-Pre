...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.8.10-beta.2/iOS/Pre/Yodo1MasMediationYandex-4.8.10-beta.2.zip' }
...
sub.dependency 'YandexMobileAds', '5.5.0'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationYandex/Core', '4.8.10-beta.2'
