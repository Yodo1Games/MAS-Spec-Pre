...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.15.2-alpha.4/iOS/Pre/Yodo1MasMediationYandex-4.15.2-alpha.4.zip' }
s.swift_version = '5.9'
...
sub.dependency 'YandexMobileAds', '7.14.1'

# Yandex is using dynamic versions of the following libraries to avoid exceptions and lock version numbers
sub.dependency 'AppMetricaCore', '5.11.0'
sub.dependency 'AppMetricaCrashes', '5.11.0'
sub.dependency 'AppMetricaLibraryAdapter', '5.11.0'
sub.dependency 'DivKitBinaryCompatibilityFacade', '5.0.0'

end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationYandex/Core', '4.15.2-alpha.4'
