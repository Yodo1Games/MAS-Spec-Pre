...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.18.0-beta.2/iOS/Pre/Yodo1MasMediationYandex-4.18.0-beta.2.zip' }
...
sub.dependency 'Yodo1MasCore', '4.18.0-beta.2'
...
sub.dependency 'Yodo1MasMediationYandex/Core', '4.18.0-beta.2'
