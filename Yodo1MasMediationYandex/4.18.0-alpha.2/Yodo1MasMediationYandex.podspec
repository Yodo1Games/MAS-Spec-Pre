...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.18.0-alpha.2/iOS/Pre/Yodo1MasMediationYandex-4.18.0-alpha.2.zip' }
...
sub.dependency 'Yodo1MasCore', '4.18.0-alpha.2'
    sub.dependency 'YandexMobileAds', '7.16.1'
    
    # Yandex is using dynamic versions of the following libraries to avoid exceptions and lock version numbers
    sub.dependency 'AppMetricaAdSupport', '5.12.1'
    sub.dependency 'AppMetricaCore', '5.12.1'
    sub.dependency 'AppMetricaCrashes', '5.12.1'
#    sub.dependency 'AppMetricaIDSync', '5.14.0'
    sub.dependency 'AppMetricaLibraryAdapter', '5.12.1'
    sub.dependency 'DivKitBinaryCompatibilityFacade', '5.2.0'
    sub.dependency 'DivKit_LayoutKit', '32.34.0'
    sub.dependency 'DivKit_LayoutKitInterface', '32.34.0'
    sub.dependency 'DivKit_Serialization', '32.34.0'
  end
  s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationYandex/Core', '4.18.0-alpha.2'
...
sub.dependency 'Yodo1MasMediationYandex/Core', '4.18.0-alpha.2'
sub.dependency 'IronSourceSDK', '9.2.0.0'
