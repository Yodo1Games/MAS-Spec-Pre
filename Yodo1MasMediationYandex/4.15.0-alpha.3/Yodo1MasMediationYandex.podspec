...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.15.0-alpha.3/iOS/Pre/Yodo1MasMediationYandex-4.15.0-alpha.3.zip' }
s.swift_version = '5.7'
...
sub.dependency 'YandexMobileAds', '7.10.2'
...
sub.dependency 'AppMetricaLibraryAdapter', '5.8.2'
sub.dependency 'DivKitBinaryCompatibilityFacade', '4.5.0'

end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationYandex/Core', '4.15.0-alpha.3'
