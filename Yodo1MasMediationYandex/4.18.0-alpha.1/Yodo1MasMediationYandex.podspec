...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.18.0-alpha.1/iOS/Pre/Yodo1MasMediationYandex-4.18.0-alpha.1.zip' }
...
sub.dependency 'Yodo1MasCore', '4.18.0-alpha.1'
...
sub.dependency 'Yodo1MasMediationYandex/Core', '4.18.0-alpha.1'
