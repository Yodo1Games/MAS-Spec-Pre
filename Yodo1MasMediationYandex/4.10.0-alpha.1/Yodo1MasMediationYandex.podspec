...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.10.0-alpha.1/iOS/Pre/Yodo1MasMediationYandex-4.10.0-alpha.1.zip' }
...
sub.dependency 'YandexMobileAds', '5.9.0'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationYandex/Core', '4.10.0-alpha.1'
