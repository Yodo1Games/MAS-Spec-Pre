Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://mas-artifacts.yodo1.com/5.0.0-alpha.3/iOS/Pre/Yodo1MasMediationYandex-5.0.0-alpha.3.zip' }
  ...
  s.subspec 'Core' do |sub|
    ...
    sub.dependency 'Yodo1MasCore', '5.0.0-alpha.3'
  ...
  s.subspec 'AppLovin' do |sub|
    sub.dependency 'Yodo1MasMediationYandex/Core', '5.0.0-alpha.3'
