...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.3-alpha.2/iOS/Pre/Yodo1MasMediationPubMatic-4.14.3-alpha.2.zip' }
s.swift_version = '5.0'
...
sub.dependency 'OpenWrapSDK', '4.3.0'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationPubMatic/Core', '4.14.3-alpha.2'
