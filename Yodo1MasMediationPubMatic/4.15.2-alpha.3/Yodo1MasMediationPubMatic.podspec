...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.15.2-alpha.3/iOS/Pre/Yodo1MasMediationPubMatic-4.15.2-alpha.3.zip' }
s.swift_version = '5.0'
...
sub.dependency 'OpenWrapSDK', '4.7.0'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationPubMatic/Core', '4.15.2-alpha.3'
