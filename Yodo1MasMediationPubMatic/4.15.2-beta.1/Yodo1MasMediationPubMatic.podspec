...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.15.2-beta.1/iOS/Pre/Yodo1MasMediationPubMatic-4.15.2-beta.1.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Yodo1MasMediationPubMatic/Core', '4.15.2-beta.1'
