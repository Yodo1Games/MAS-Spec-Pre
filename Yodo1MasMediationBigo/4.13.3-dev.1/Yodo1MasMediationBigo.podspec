...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.13.3-dev.1/iOS/Pre/Yodo1MasMediationBigo-4.13.3-dev.1.zip' }
...
sub.dependency 'BigoADS', '4.2.3'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationBigo/Core', '4.13.3-dev.1'
