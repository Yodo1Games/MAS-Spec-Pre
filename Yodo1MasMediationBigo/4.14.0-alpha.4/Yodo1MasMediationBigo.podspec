...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.0-alpha.4/iOS/Pre/Yodo1MasMediationBigo-4.14.0-alpha.4.zip' }
...
sub.dependency 'BigoADS', '4.5.1'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationBigo/Core', '4.14.0-alpha.4'
sub.dependency 'AppLovinSDK', '12.6.1'
# sub.vendored_frameworks = s.name + '/Lib/bigo_ads_max_adapter.xcframework'
sub.dependency 'bigo-ads-max-adapter', '4.5.1.0'
end
end
