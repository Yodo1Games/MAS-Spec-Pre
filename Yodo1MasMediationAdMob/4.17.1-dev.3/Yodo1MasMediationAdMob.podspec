...
s.version = '4.17.1-dev.3'
  ...
  DESC
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.17.1-dev.3/iOS/Pre/Yodo1MasMediationAdMob-4.17.1-dev.3.zip' }
  s.swift_version    = '5.0'
...
sub.dependency 'Yodo1MasCore', '4.17.1-dev.3'
sub.dependency 'Google-Mobile-Ads-SDK', '12.9.0'
  end
  s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationAdMob/Core', '4.17.1-dev.3'
