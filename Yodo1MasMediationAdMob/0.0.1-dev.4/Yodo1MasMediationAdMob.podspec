...
s.source = { :http => 'https://mas-artifacts.yodo1.com/0.0.1-dev.4/iOS/Pre/Yodo1MasMediationAdMob-0.0.1-dev.4.zip' }
...
sub.dependency 'Yodo1MasMediationAdMob/Core', '0.0.1-dev.4'
