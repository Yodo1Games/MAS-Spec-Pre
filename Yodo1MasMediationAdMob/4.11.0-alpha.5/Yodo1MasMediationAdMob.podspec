...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.11.0-alpha.5/iOS/Pre/Yodo1MasMediationAdMob-4.11.0-alpha.5.zip' }
...
sub.dependency 'Google-Mobile-Ads-SDK', '10.14.0'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationAdMob/Core', '4.11.0-alpha.5'
