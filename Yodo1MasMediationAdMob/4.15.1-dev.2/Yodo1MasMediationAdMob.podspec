...
DESC
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.15.1-dev.2/iOS/Pre/Yodo1MasMediationAdMob-4.15.1-dev.2.zip' }
s.swift_version = '5.0'
...
s.resources = s.name + '/Assets/Yodo1MasAdMobNativeResources.bundle', s.name + '/Assets/Yodo1MasAdMob.plist'
...
sub.dependency 'Yodo1MasMediationAdMob/Core', '4.15.1-dev.2'
