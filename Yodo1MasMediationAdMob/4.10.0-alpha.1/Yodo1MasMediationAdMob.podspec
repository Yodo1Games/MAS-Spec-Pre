...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.10.0-alpha.1/iOS/Pre/Yodo1MasMediationAdMob-4.10.0-alpha.1.zip' }
...
sub.dependency 'Google-Mobile-Ads-SDK', '10.8.0'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationAdMob/Core', '4.10.0-alpha.1'
