...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.8.11-rev-beta.1/iOS/Pre/Yodo1MasMediationAdMob-4.8.11-rev-beta.1.zip' }
...
sub.dependency 'Yodo1MasMediationAdMob/Core', '4.8.11-rev-beta.1'
