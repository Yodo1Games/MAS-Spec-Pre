...
DESC
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.15.1-dev.1/iOS/Pre/Yodo1MasMediationAdMob-4.15.1-dev.1.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Yodo1MasMediationAdMob/Core', '4.15.1-dev.1'
