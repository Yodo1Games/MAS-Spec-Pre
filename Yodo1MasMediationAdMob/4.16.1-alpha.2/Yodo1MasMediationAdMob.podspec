...
DESC
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.16.1-alpha.2/iOS/Pre/Yodo1MasMediationAdMob-4.16.1-alpha.2.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Yodo1MasMediationAdMob/Core', '4.16.1-alpha.2'
