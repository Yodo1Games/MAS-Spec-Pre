...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.10.0-alpha.1/iOS/Pre/Yodo1MasMediationUnityAds-4.10.0-alpha.1.zip' }
...
sub.dependency 'UnityAds', '4.8.0'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationUnityAds/Core', '4.10.0-alpha.1'
