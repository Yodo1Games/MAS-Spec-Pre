...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.8.10-beta.2/iOS/Pre/Yodo1MasMediationUnityAds-4.8.10-beta.2.zip' }
...
sub.dependency 'UnityAds', '4.6.0'
end
s.subspec 'AdMob' do |sub|
sub.dependency 'Yodo1MasMediationUnityAds/Core', '4.8.10-beta.2'
