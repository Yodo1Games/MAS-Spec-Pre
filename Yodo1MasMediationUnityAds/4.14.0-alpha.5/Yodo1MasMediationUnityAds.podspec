...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.0-alpha.5/iOS/Pre/Yodo1MasMediationUnityAds-4.14.0-alpha.5.zip' }
...
sub.dependency 'UnityAds', '4.12.2'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationUnityAds/Core', '4.14.0-alpha.5'
