...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.3-alpha.2/iOS/Pre/Yodo1MasMediationUnityAds-4.14.3-alpha.2.zip' }
s.swift_version = '5.0'
...
sub.dependency 'UnityAds', '4.13.0'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationUnityAds/Core', '4.14.3-alpha.2'
