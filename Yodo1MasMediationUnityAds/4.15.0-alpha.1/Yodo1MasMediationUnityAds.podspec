...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.15.0-alpha.1/iOS/Pre/Yodo1MasMediationUnityAds-4.15.0-alpha.1.zip' }
s.swift_version = '5.0'
...
sub.dependency 'UnityAds', '4.13.1'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationUnityAds/Core', '4.15.0-alpha.1'
