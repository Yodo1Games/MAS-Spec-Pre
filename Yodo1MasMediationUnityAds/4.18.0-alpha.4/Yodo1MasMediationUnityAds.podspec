...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.18.0-alpha.4/iOS/Pre/Yodo1MasMediationUnityAds-4.18.0-alpha.4.zip' }
  s.swift_version    = '5.0'
...
sub.dependency 'Yodo1MasCore', '4.18.0-alpha.4'
    sub.dependency 'UnityAds', '4.17.0'
  end
  s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationUnityAds/Core', '4.18.0-alpha.4'
