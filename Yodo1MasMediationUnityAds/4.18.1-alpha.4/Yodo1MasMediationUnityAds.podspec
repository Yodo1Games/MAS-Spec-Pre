...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.18.1-alpha.4/iOS/Pre/Yodo1MasMediationUnityAds-4.18.1-alpha.4.zip' }
  s.swift_version    = '5.0'
...
sub.dependency 'Yodo1MasMediationUnityAds/Core', '4.18.1-alpha.4'
