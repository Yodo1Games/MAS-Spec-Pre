Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://mas-artifacts.yodo1.com/5.0.0-beta.3/iOS/Pre/Yodo1MasMediationUnityAds-5.0.0-beta.3.zip' }
  s.swift_version    = '5.0'
  ...
  s.subspec 'AppLovin' do |sub|
    sub.dependency 'Yodo1MasMediationUnityAds/Core', '5.0.0-beta.3'
