...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.13.3-dev.1/iOS/Pre/Yodo1MasMediationFyber-4.13.3-dev.1.zip' }
...
sub.dependency 'Fyber_Marketplace_SDK', '8.2.8'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationFyber/Core', '4.13.3-dev.1'
