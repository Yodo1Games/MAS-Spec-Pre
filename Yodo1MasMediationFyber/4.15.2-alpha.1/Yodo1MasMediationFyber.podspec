...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.15.2-alpha.1/iOS/Pre/Yodo1MasMediationFyber-4.15.2-alpha.1.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Fyber_Marketplace_SDK', '8.3.5'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationFyber/Core', '4.15.2-alpha.1'
