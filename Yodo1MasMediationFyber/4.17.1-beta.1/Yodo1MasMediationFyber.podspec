...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.17.1-beta.1/iOS/Pre/Yodo1MasMediationFyber-4.17.1-beta.1.zip' }
  s.swift_version    = '5.0'
...
sub.dependency 'Yodo1MasMediationFyber/Core', '4.17.1-beta.1'
