...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.9.0-alpha.2/iOS/Pre/Yodo1MasMediationFyber-4.9.0-alpha.2.zip' }
...
sub.vendored_frameworks = s.name + '/Lib/IASDKCore.xcframework'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationFyber/Core', '4.9.0-alpha.2'
