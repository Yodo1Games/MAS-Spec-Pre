...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.0-alpha.5/iOS/Pre/Yodo1MasMediationFyber-4.14.0-alpha.5.zip' }
...
sub.dependency 'Fyber_Marketplace_SDK', '8.3.2'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationFyber/Core', '4.14.0-alpha.5'
