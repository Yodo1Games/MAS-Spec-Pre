...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.8.10-alpha.2/iOS/Pre/Yodo1MasMediationFyber-4.8.10-alpha.2.zip' }
...
sub.dependency 'Yodo1MasMediationFyber/Core', '4.8.10-alpha.2'
