...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.15.0-alpha.2/iOS/Pre/Yodo1MasMediationFyber-4.15.0-alpha.2.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Yodo1MasMediationFyber/Core', '4.15.0-alpha.2'
