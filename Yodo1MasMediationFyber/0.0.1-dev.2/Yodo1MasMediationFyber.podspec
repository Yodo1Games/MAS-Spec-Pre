...
s.source = { :http => 'https://mas-artifacts.yodo1.com/0.0.1-dev.2/iOS/Pre/Yodo1MasMediationFyber-0.0.1-dev.2.zip' }
...
sub.dependency 'Yodo1MasMediationFyber/Core', '0.0.1-dev.2'
