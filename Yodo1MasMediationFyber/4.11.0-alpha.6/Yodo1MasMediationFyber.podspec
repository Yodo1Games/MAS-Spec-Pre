...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.11.0-alpha.6/iOS/Pre/Yodo1MasMediationFyber-4.11.0-alpha.6.zip' }
...
sub.dependency 'Fyber_Marketplace_SDK', '8.2.5'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationFyber/Core', '4.11.0-alpha.6'
