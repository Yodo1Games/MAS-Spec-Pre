...
TODO: Add long description of the pod here.
  ...
  s.source           = { :http => 'https://bj-ali-ops-sdk-docs.oss-cn-beijing.aliyuncs.com/download/Rivendell-SDKs/4.1.0/Yodo1MasMediationFyber-4.1.0.zip' }
  ...
  s.dependency 'FairBidSDK', '~> 3.12.0'
end
