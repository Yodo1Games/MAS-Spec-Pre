...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.2-alpha.3/iOS/Pre/Yodo1MasMediationFyber-4.14.2-alpha.3.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Fyber_Marketplace_SDK', '8.3.4'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationFyber/Core', '4.14.2-alpha.3'
