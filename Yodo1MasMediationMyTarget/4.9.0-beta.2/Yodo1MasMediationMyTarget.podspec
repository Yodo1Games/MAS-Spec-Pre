...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.9.0-beta.2/iOS/Pre/Yodo1MasMediationMyTarget-4.9.0-beta.2.zip' }
...
sub.dependency 'Yodo1MasCore', '4.9.0-beta.2'
sub.dependency 'myTargetSDK', '5.18.0'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationMyTarget/Core', '4.9.0-beta.2'
