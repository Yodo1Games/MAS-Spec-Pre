...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.8.10-beta.2/iOS/Pre/Yodo1MasMediationMyTarget-4.8.10-beta.2.zip' }
...
sub.dependency 'Yodo1MasCore', '4.8.10-beta.2'
sub.dependency 'myTargetSDK', '5.16.0'
end
s.subspec 'AdMob' do |sub|
sub.dependency 'Yodo1MasMediationMyTarget/Core', '4.8.10-beta.2'
