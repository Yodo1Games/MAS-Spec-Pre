...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.15.2-alpha.4/iOS/Pre/Yodo1MasMediationChartboost-4.15.2-alpha.4.zip' }
s.swift_version = '5.0'
...
sub.dependency 'ChartboostSDK', '9.8.1'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationChartboost/Core', '4.15.2-alpha.4'
