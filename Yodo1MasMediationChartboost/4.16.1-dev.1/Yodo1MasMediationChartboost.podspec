...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.16.1-dev.1/iOS/Pre/Yodo1MasMediationChartboost-4.16.1-dev.1.zip' }
s.swift_version = '5.0'
...
sub.dependency 'ChartboostSDK', '9.9.1'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationChartboost/Core', '4.16.1-dev.1'
...
sub.vendored_frameworks = s.name + '/Lib/ISChartboostAdapter.xcframework'
end
s.subspec 'TopOn' do |sub|
sub.dependency 'Yodo1MasMediationChartboost/Core', '4.16.1-dev.1'
sub.dependency 'TPNiOS', '6.4.91'
sub.vendored_frameworks = s.name + '/Lib/AnyThinkChartboostAdapter.framework'
end
end
