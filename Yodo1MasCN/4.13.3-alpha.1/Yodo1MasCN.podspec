...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.13.3-alpha.1/iOS/Pre/Yodo1MasCN-4.13.3-alpha.1.zip' }
...
s.dependency 'Yodo1MasCore', '4.13.3-alpha.1'
s.dependency 'Yodo1MasMediationToBid', '4.13.3-alpha.1'
s.dependency 'Yodo1MasMediationYodo1', '4.13.3-alpha.1'
end
