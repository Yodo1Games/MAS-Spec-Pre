...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.8.11-rev-beta.1/iOS/Pre/Yodo1MasMediationFacebook-4.8.11-rev-beta.1.zip' }
...
sub.dependency 'Yodo1MasMediationFacebook/Core', '4.8.11-rev-beta.1'
