...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.13.3-dev.1/iOS/Pre/Yodo1MasMediationFacebook-4.13.3-dev.1.zip' }
...
sub.dependency 'FBAudienceNetwork', '6.15.0'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationFacebook/Core', '4.13.3-dev.1'
