...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.17.1-alpha.1/iOS/Pre/Yodo1MasMediationFacebook-4.17.1-alpha.1.zip' }
s.swift_version = '5.0'
...
sub.dependency 'FBAudienceNetwork', '6.20.1'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationFacebook/Core', '4.17.1-alpha.1'
