...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.16.1-alpha.2/iOS/Pre/Yodo1MasMediationFacebook-4.16.1-alpha.2.zip' }
s.swift_version = '5.0'
...
sub.dependency 'FBAudienceNetwork', '6.20.0'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationFacebook/Core', '4.16.1-alpha.2'
