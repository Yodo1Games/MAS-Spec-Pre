...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.11.0-alpha.5/iOS/Pre/Yodo1MasMediationFacebook-4.11.0-alpha.5.zip' }
...
sub.dependency 'FBAudienceNetwork', '6.14.0'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationFacebook/Core', '4.11.0-alpha.5'
