...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.15.0-alpha.2/iOS/Pre/Yodo1MasMediationFacebook-4.15.0-alpha.2.zip' }
s.swift_version = '5.0'
...
sub.dependency 'FBAudienceNetwork', '6.16.0'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationFacebook/Core', '4.15.0-alpha.2'
