...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.9.3-alpha.2/iOS/Pre/Yodo1MasMediationFacebook-4.9.3-alpha.2.zip' }
...
sub.dependency 'Yodo1MasMediationFacebook/Core', '4.9.3-alpha.2'
