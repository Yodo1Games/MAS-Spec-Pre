...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.2-alpha.3/iOS/Pre/Yodo1MasMediationFacebook-4.14.2-alpha.3.zip' }
s.swift_version = '5.0'
...
sub.dependency 'FBAudienceNetwork', '6.15.2'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationFacebook/Core', '4.14.2-alpha.3'
