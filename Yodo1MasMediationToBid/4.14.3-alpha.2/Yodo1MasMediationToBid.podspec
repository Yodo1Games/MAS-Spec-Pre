...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.3-alpha.2/iOS/Pre/Yodo1MasMediationToBid-4.14.3-alpha.2.zip' }
s.swift_version = '5.0'
...
sub.dependency 'ToBid-iOS/BaiduAdapter', '4.3.10'
sub.dependency 'ToBid-iOS/KSAdapter', '4.3.10'
# sub.dependency, '4.3.10'
# sub.dependency, '4.3.10'
# sub.dependency, '4.3.10'
