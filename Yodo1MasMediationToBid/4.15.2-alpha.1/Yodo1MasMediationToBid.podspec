...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.15.2-alpha.1/iOS/Pre/Yodo1MasMediationToBid-4.15.2-alpha.1.zip' }
s.swift_version = '5.0'
...
sub.dependency 'ToBid-iOS/BaiduAdapter', '4.5.4'
sub.dependency 'ToBid-iOS/KSAdapter', '4.5.4'
# sub.dependency, '4.5.4'
# sub.dependency, '4.5.4'
# sub.dependency, '4.5.4'
