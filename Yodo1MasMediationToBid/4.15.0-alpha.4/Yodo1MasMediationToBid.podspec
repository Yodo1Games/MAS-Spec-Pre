...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.15.0-alpha.4/iOS/Pre/Yodo1MasMediationToBid-4.15.0-alpha.4.zip' }
s.swift_version = '5.0'
...
sub.dependency 'ToBid-iOS/BaiduAdapter', '4.3.20'
sub.dependency 'ToBid-iOS/KSAdapter', '4.3.20'
# sub.dependency, '4.3.20'
# sub.dependency, '4.3.20'
# sub.dependency, '4.3.20'
