...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.13.3-alpha.1/iOS/Pre/Yodo1MasMediationToBid-4.13.3-alpha.1.zip' }
...
sub.dependency 'Yodo1MasCore', '4.13.3-alpha.1'
sub.dependency 'ToBid-iOS', '3.9.0'
sub.dependency 'ToBid-iOS/AdmobAdapter', '3.9.0'
sub.dependency 'ToBid-iOS/TouTiaoAdapter', '3.9.0'
sub.dependency 'ToBid-iOS/MintegralAdapter', '3.9.0'
