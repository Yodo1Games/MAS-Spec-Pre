...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.17.1-beta.2/iOS/Pre/Yodo1MasMediationToBid-4.17.1-beta.2.zip' }
  s.swift_version    = '5.0'
...
sub.dependency 'ToBid-iOS/ToBidSDK', '4.6.80'
sub.dependency 'ToBid-iOS/BidResultAdapter', '4.6.80'
sub.dependency 'ToBid-iOS/BaiduAdapter', '4.6.80'
sub.dependency 'ToBid-iOS/KSAdapter', '4.6.80'
# sub.dependency, '4.6.80'
# sub.dependency, '4.6.80'
# sub.dependency, '4.6.80'
