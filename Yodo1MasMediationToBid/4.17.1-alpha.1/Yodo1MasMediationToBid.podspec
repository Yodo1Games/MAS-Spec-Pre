...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.17.1-alpha.1/iOS/Pre/Yodo1MasMediationToBid-4.17.1-alpha.1.zip' }
s.swift_version = '5.0'
...
sub.dependency 'ToBid-iOS/BidResultAdapter', '4.5.20'
sub.dependency 'ToBid-iOS/BaiduAdapter', '4.5.20'
sub.dependency 'ToBid-iOS/KSAdapter', '4.5.20'
# sub.dependency, '4.5.20'
# sub.dependency, '4.5.20'
# sub.dependency, '4.5.20'
