...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.15.1-dev.2/iOS/Pre/Yodo1MasMediationMaticoo-4.15.1-dev.2.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Yodo1MasMediationMaticoo/Core', '4.15.1-dev.2'
