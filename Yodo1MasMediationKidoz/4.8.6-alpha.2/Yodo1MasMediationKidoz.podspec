...
s.summary = 'Yodo1MasMediationKidoz'
s.swift_version = '5.0'
...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.8.6-alpha.2/iOS/Pre/Yodo1MasMediationKidoz-4.8.6-alpha.2.zip' }
...
s.source_files = s.name + '/Lib/*.h'#, s.name + '/Classes/*'
s.public_header_files = s.name + '/Lib/*.h'#, s.name + '/Classes/*.h'
