...
#s.vendored_frameworks = s.name + '/Lib/*.a'
s.vendored_libraries = s.name + '/Lib/*.a'
s.dependency 'Yodo1MasCore', '4.8.9'
s.dependency 'Yodo1MasMediationApplovin/Core', '4.8.9'
s.dependency 'Yodo1MasMediationIronSource/Core', '4.8.9'
end
