...
s.summary = 'Kidoz adapter used for mediation with the Yodo1 MAS SDK'
s.swift_version = '5.0'
...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.11.0-alpha.6/iOS/Pre/Yodo1MasMediationKidoz-4.11.0-alpha.6.zip' }
