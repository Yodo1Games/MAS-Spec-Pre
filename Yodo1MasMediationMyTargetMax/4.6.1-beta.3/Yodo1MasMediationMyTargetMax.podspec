...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.6.1-beta.3/iOS/Pre/Yodo1MasMediationMyTargetMax-4.6.1-beta.3.zip' }
...
s.dependency 'Yodo1MasMediationMyTarget', '4.6.1-beta.3'
s.dependency 'Yodo1MasMediationAdMob', '4.6.1-beta.3'
s.dependency 'Yodo1MasMediationApplovin', '4.6.1-beta.3'
s.dependency 'Yodo1MasMediationIronSource', '4.6.1-beta.3'
end
