...
Pod::Spec.new do |s|
s.name = 'Yodo1MasMediationBadMachine'
...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.9.3-beta.1/iOS/Pre/Yodo1MasMediationBadMachine-4.9.3-beta.1.zip' }
...
sub.dependency 'Yodo1MasMediationBadMachine/Core', '4.9.3-beta.1'
