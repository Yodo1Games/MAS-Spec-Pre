...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.7.7-alpha.1/iOS/Pre/Yodo1MasLite-4.7.7-alpha.1.zip' }
...
s.dependency 'Yodo1MasCore', '4.7.7-alpha.1'
s.dependency 'Yodo1MasMediationAdMob', '4.7.7-alpha.1'
s.dependency 'Yodo1MasMediationApplovin', '4.7.7-alpha.1'
s.dependency 'Yodo1MasMediationFacebook', '4.7.7-alpha.1'
s.dependency 'Yodo1MasMediationUnityAds', '4.7.7-alpha.1'
s.dependency 'Yodo1MasMediationYodo1', '4.7.7-alpha.1'
end
