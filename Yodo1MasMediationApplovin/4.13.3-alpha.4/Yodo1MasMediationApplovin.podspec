...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.13.3-alpha.4/iOS/Pre/Yodo1MasMediationApplovin-4.13.3-alpha.4.zip' }
...
sub.dependency 'Yodo1MasMediationApplovin/Amazon', '4.13.3-alpha.4'
end
