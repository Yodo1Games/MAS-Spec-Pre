...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.0-beta.1/iOS/Pre/Yodo1MasMediationApplovin-4.14.0-beta.1.zip' }
...
sub.dependency 'Yodo1MasMediationApplovin/Amazon', '4.14.0-beta.1'
end
