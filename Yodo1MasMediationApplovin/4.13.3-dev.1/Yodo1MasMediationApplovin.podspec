...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.13.3-dev.1/iOS/Pre/Yodo1MasMediationApplovin-4.13.3-dev.1.zip' }
...
# sub.dependency 'AmazonPublisherServicesSDK', '4.9.5'
...
sub.dependency 'Yodo1MasMediationApplovin/Amazon', '4.13.3-dev.1'
end
