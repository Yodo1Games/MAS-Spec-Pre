Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://mas-artifacts.yodo1.com/5.0.0-beta.1/iOS/Pre/Yodo1MasMediationApplovin-5.0.0-beta.1.zip' }
  s.swift_version    = '5.0'
  ...
  s.subspec 'AdMob' do |sub|
    sub.dependency 'Yodo1MasMediationApplovin/Core', '5.0.0-beta.1'
  ...
  s.subspec 'Aurion11' do |sub|
    sub.dependency 'Yodo1MasMediationApplovin/Core', '5.0.0-beta.1'
    sub.dependency 'Yodo1MasMediationAurion11/A11Mediation', '5.0.0-beta.1'
