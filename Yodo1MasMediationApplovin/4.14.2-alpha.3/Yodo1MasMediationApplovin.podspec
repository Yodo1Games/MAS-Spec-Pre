...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.2-alpha.3/iOS/Pre/Yodo1MasMediationApplovin-4.14.2-alpha.3.zip' }
s.swift_version = '5.0'
...
sub.dependency 'AmazonPublisherServicesSDK', '4.10.1'
end
s.subspec 'AdMob' do |sub|
# sub.resource = s.name + '/Assets/**/*'

sub.vendored_frameworks = "#{s.name}/#{s.name}.xcframework"
sub.dependency 'Yodo1MasMediationApplovin/Core', '4.14.2-alpha.3'
