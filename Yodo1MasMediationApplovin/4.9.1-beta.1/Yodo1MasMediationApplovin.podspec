...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.9.1-beta.1/iOS/Pre/Yodo1MasMediationApplovin-4.9.1-beta.1.zip' }
...
sub.dependency 'Yodo1MasCore', '4.9.1-beta.1'
sub.dependency 'AppLovinSDK', '11.10.1'
end
# s.subspec 'AdMob' do |sub|
# sub.dependency, '4.9.1-beta.1'
