...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.13.2-alpha.8/iOS/Pre/Yodo1MasMediationApplovin-4.13.2-alpha.8.zip' }
...
sub.dependency 'Yodo1MasMediationApplovin/Amazon', '4.13.2-alpha.8'
end
