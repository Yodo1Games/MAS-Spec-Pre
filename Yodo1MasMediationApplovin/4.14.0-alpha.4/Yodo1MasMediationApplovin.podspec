...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.0-alpha.4/iOS/Pre/Yodo1MasMediationApplovin-4.14.0-alpha.4.zip' }
...
sub.dependency 'Yodo1MasMediationApplovin/Amazon', '4.14.0-alpha.4'
end
