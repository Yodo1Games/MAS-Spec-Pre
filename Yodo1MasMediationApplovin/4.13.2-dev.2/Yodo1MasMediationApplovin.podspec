...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.13.2-dev.2/iOS/Pre/Yodo1MasMediationApplovin-4.13.2-dev.2.zip' }
...
sub.dependency 'Yodo1MasMediationApplovin/Amazon', '4.13.2-dev.2'
end
